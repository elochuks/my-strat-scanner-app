    ...
    for ticker in (
        ...
        try:
            ...
            if weekly:
                ...
                pwl = None
                pwh = None
                previous_week_strat = "N/A"
                current_week_strat = "N/A"
                pct_pwl = None
                pct_pwh = None
            ...
            if monthly:
                ...
                pml = None
                pmh = None
                previous_month_strat = "N/A"
                current_month_strat = "N/A"
                pct_pml = None
                pct_pmh = None
...
with weekly_tab:
    ...
    st.caption(
        ...
        "Reclaim/Reject → Daily STRAT → Weekly FTFC"
    )
...
with monthly_tab:
    ...
    st.caption(
        ...
        "Reclaim/Reject → Weekly STRAT → Monthly FTFC"
    )
